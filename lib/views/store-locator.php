				      ...
				      while ( have_posts() ) : the_post(); ?>
						...
						<div class="store-branding">
							...
							<?php if( have_rows('stores') ) {
									...
									<div class="partner">
									<h3><?php //echo get_sub_field('brands'); ?></h3>
										<div class="partner-imgs">
											<?php //while ( have_rows('store_image') ) : the_row();?>
													<div class="partner-img">
														<?php echo wp_get_attachment_image(get_sub_field('store_image'), 'medium', false, array( 'class' => '')); ?>
													</div>
												<?php
											//endwhile;?>
										</div>
										<?php echo '<div class="partner-list"><ul>'; while ( have_rows('brands') ) : the_row(); ?>
											<?php echo '<li>' . get_sub_field('brand_name') . '</li>'; ?>
